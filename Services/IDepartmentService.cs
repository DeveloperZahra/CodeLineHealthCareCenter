...
namespace HospitalSystemTeamTask.Services
{
    public interface IDepartmentService
    {
        ...
        void GetDepartmentDetail(string departmentName); //Finds and displays a department by its name.
        void GetDepartmentDetail(int departmentId); //Finds and displays a department by its ID.
